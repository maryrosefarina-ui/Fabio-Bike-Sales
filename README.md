...
The SQL performs data profiling to understand all aspects of the data. [view]( https://github.com/maryrosefarina-ui/Fabio-Bike-Sales/blob/main/scripts/1_Database.sql)

SQL queries generate reports that address various business questions. [view]( https://github.com/maryrosefarina-ui/Fabio-Bike-Sales/blob/main/scripts/3_Data_Analytics_Queries.sql)

SQL queries are utilized to clean, organize, and prepare data for the dashboard. [view]( https://github.com/maryrosefarina-ui/Fabio-Bike-Sales/blob/main/scripts/4_Cleaned_Data_Analysis.sql)

SQL creates a table or view for users or stakeholders to analyze for decision-making. [view customer reports]( https://github.com/maryrosefarina-ui/Fabio-Bike-Sales/blob/main/scripts/Customer_Reports.sql) [view product reports]( https://github.com/maryrosefarina-ui/Fabio-Bike-Sales/blob/main/scripts/Product_Reports.sql)

An interactive Tableau Dashboard can be downloaded [here.]( https://github.com/maryrosefarina-ui/Fabio-Bike-Sales/releases/download/v1.0/Sales & Customer Dashboard.twbx)
